...
from brevitas.nn import QuantConv2d, QuantConv1d, QuantLinear, QuantAdd2d
import adder
...
class PytorchQuantAddNdHandler(PytorchQuantWBIOLHandler, ABC):
    ...
    @classmethod
    def prepare_qf_kwargs(cls, module: Union[QuantAdd2d]):
        return {
            'bias': cls.prepare_bias(module),
            'stride': module.stride,
            'padding': module.padding,
...
class PytorchQuantAdd2dHandler(PytorchQuantAddNdHandler):
    handled_layer = QuantAdd2d

    @classmethod
    def prepare_qf(cls, module: QuantAdd2d):
        return adder.Adder2DFunction, cls.prepare_qf_kwargs(module)
