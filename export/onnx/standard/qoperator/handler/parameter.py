...
class StdQOpONNXQuantAddNdHandler(StdQOpONNXQuantWBIOLHandler, ABC):

    def op_symbolic_kwargs(self, module: QuantAdd2d):
        conv_symbolic_kwargs = {
            'input_scale': module.quant_input_scale(),
            'input_zero_point': self.quant_input_zero_point(module),
            'int_weight': self.int_weight(module),
    ...
    def prepare_for_export(self, module: QuantAdd2d):
        self.validate(module)
...
class StdQOpONNXQuantAdd2dHandler(StdQOpONNXQuantAddNdHandler, Kernel2dApplHandlerMixin):
